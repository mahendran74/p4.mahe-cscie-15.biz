...
<body>
  ...
  <div class="container marketing">
    ...
    <div class="row">
      <div class="col-lg-4">
        <img class="img-circle" data-src="holder.js/140x140/#2c3e50:#fff/text:Administrator" src="#" alt="Generic placeholder image"/>
        <h2>Administrator</h2>
         <p>
      ...
      <!-- /.col-lg-4 -->
      <div class="col-lg-4">
        <img class="img-circle" data-src="holder.js/140x140/#6E2C50:#fff/text:Team Member " src="#" alt="Generic placeholder image"/>
        <h2>Team Member</h2>
